...
{
    /// <summary>
    /// A maker of SCARED Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime SCARED repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM SCARED FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetSCAREDFactories()
        {
        ...
        /// <summary>
        /// Constructor that initializes with runtime SCARED repository factories
        /// </summary>
        public RepositoryFactories()  
        {
            _repositoryFactories = GetSCAREDFactories();
        }
